...
{
    class ResgateUnico : Torneio
    {
        public static int num_participantes { get; private set; } = 16;
        public static int num_grupos { get; private set; } = 4;
        ...
        public static void Comecar()
        {
            ...
            if (grupo == -1) //significa que a fase nem começou ainda
            {
                ...
                Console.WriteLine("\nEntrando na Fase de Resgate Único");
            ...
            while (true) //só acaba quando a fase termina ou o programa é encerrado abruptamente
            {
                ...
                Console.WriteLine("--------------------------------------------------------------------");
                Console.WriteLine("FASE DE RESGATE ÚNICO - Grupo {0} - Rodada {1}", grupo, int.Parse(texto[0]) + 1);
                ...
                if (grupo == num_grupos & int.Parse(texto[0]) == 3) //se a fase terminou, hora de computar os resgatados
                {
                    ...
                    List<Challenger> resgatados = Classificados(eliminados, 1);
