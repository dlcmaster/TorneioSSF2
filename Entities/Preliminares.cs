...
{
    class Preliminares : Torneio
    {
        public static int num_participantes { get; private set; } = 42;
        public static int num_grupos { get; private set; } = 14;
        ...
        public static void Comecar ()
        {
            ...
            {
                string todos_participantes = File.ReadAllText(path_participantes_original);
                File.WriteAllText(path_participantes, todos_participantes);
            ...
            while (true) //só acaba quando a fase termina ou o programa é encerrado abruptamente
            {
                ...
                Console.WriteLine("--------------------------------------------------------------------");
                Console.WriteLine("PRELIMINARES - Grupo {0} - Rodada {1}", grupo, int.Parse(texto[0]) + 1);
