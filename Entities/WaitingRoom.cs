...
{
    class WaitingRoom : Torneio
    {
        public static int num_participantes { get; private set; } = 6;
        public static int num_grupos { get; private set; } = 2;
        ...
        public static void Comecar()
        {
            ...
            while (true) //só acaba quando a fase termina ou o programa é encerrado abruptamente
            {
                ...
                Console.WriteLine("--------------------------------------------------------------------");
                Console.WriteLine("WAITING ROOM - Grupo {0} - Rodada {1}", grupo, int.Parse(texto[0]) + 1);
